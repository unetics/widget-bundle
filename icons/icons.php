...
function siteorigin_widgets_icons_elf_filter( $icons ){
	return array(
		'search' 		=> '&#xf002;',
		'envelope-o' 	=> '&#xf003;',
		'heart' 		=> '&#xf004;',
...
add_filter('siteorigin_widgets_icons_elf', 'siteorigin_widgets_icons_elf_filter');
...
*/
	$families['elf'] = array(
		'name' => 'ELF',
		'style_uri' => plugin_dir_url(__FILE__).'elf/style.css',
		'icons' => apply_filters('siteorigin_widgets_icons_elf', array() ),
	);
